...
<html>
    ...
    <head>
        ...
        <!--The Main Css-->
        <link href="styles/css/404.css" rel="stylesheet">
    ...
    <body>
        ...
        <main id="main">
            ...
            <section id="404" class="d-flex justify-content-center">

                <div class="image">

                    <img src="images/404-error-page-not-found-with-people-connecting-a-plug-animate.svg" class="img-fluid animated" alt="">
    
                </div>

            </section>

            <section id="back" class="justify-content-center">

                <div class="d-flex justify-content-center">

                    <h3>The page you are looking for might have been removed or temporary unavailable at the moment</h3>

                </div>

            </section>

            <section id="home-button" class="d-flex justify-content-center">

                <div class="button">

                    <a href="index.php" class="btn-get-started scrollto">Homepage</a>
